...
-(void)awakeFromNib{
    ...
    meshCube.tris = {
        ...
        // SOUTH
        { 0.0f, 0.0f, 0.0f, 1.0,    0.0f, 1.0f, 0.0f, 1.0,    1.0f, 1.0f, 0.0f, 1.0 },
        { 0.0f, 0.0f, 0.0f, 1.0,    1.0f, 1.0f, 0.0f, 1.0,    1.0f, 0.0f, 0.0f, 1.0 },
        // EAST 1. 0, 1.0,, 1.
        { 1.0f, 0.0f, 0.0f, 1.0,    1.0f, 1.0f, 0.0f, 1.0,    1.0f, 1.0f, 1.0f, 1.0 },
        { 1.0f, 0.0f, 0.0f, 1.0,    1.0f, 1.0f, 1.0f, 1.0,    1.0f, 0.0f, 1.0f, 1.0 },
        // NORTH 1. 0, 1.0,, 10
        { 1.0f, 0.0f, 1.0f, 1.0,    1.0f, 1.0f, 1.0f, 1.0,    0.0f, 1.0f, 1.0f, 1.0 },
        { 1.0f, 0.0f, 1.0f, 1.0,    0.0f, 1.0f, 1.0f, 1.0,    0.0f, 0.0f, 1.0f, 1.0 },
        // WEST 1. 0, 1.0,, 1.
        { 0.0f, 0.0f, 1.0f, 1.0,    0.0f, 1.0f, 1.0f, 1.0,    0.0f, 1.0f, 0.0f, 1.0 },
        { 0.0f, 0.0f, 1.0f, 1.0,    0.0f, 1.0f, 0.0f, 1.0,    0.0f, 0.0f, 0.0f, 1.0 },
        // TOP 1. 0, 1.0,, 1.
        { 0.0f, 1.0f, 0.0f, 1.0,    0.0f, 1.0f, 1.0f, 1.0,    1.0f, 1.0f, 1.0f, 1.0 },
        { 0.0f, 1.0f, 0.0f, 1.0,    1.0f, 1.0f, 1.0f, 1.0,    1.0f, 1.0f, 0.0f, 1.0 },
        // BOTTOM 1. 0, 1.0,, .0
        { 1.0f, 0.0f, 1.0f, 1.0,    0.0f, 0.0f, 1.0f, 1.0,    0.0f, 0.0f, 0.0f, 1.0 },
        { 1.0f, 0.0f, 1.0f, 1.0,    0.0f, 0.0f, 0.0f, 1.0,    1.0f, 0.0f, 0.0f, 1.0 },
    };
...
//    Fill(0, 0, ScreenWidth(), ScreenHeight(), PIXEL_SOLID, FG_BLACK);
    ...
    for (auto &triToRaster : vecTrianglesToRaster)
    {
        ...
        for (auto &t : listTriangles)
        {
            ...
            [triPath moveToPoint:CGPointMake(t.p[0].x, t.p[0].y)];
            [triPath addLineToPoint:CGPointMake(t.p[1].x, t.p[1].y)];
            [triPath addLineToPoint:CGPointMake(t.p[2].x, t.p[2].y)];
            [triPath closePath];
